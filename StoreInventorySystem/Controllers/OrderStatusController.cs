...
namespace StoreInventorySystem.Controllers
{
    public class OrderStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,OrderStatusName,OrderStatusDescription")] OrderStatus orderStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,OrderStatusName,OrderStatusDescription")] OrderStatus orderStatus)
        {
            if (ModelState.IsValid)
            {
